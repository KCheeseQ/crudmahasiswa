...
class mahasiswa extends CI_Controller
{
    ...
    function tambah()
    {
        ...
        $this->form_validation->set_rules('no_hp', 'No HP Mahasiswa', 'required', [
    ...
    public function edit($id)
    {
        ...
        if($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data Mahasiswa Berhasil Di Ubah!</div>');
            redirect('Mahasiswa');
        }
    }
    function update()
