       ...
       <div class="card-body">
         <form action="" method="POST">
           ...
           <div class="form-group">
             ...
             <?= form_error('nim', '<small class="texto-danger pl-3">', '</small>'); ?>
           </div>
           <div class="form-group">
             ...
             <?= form_error('jenis_kelamin', '<small class="texto-danger pl-3">', '</small>'); ?>
           </div>
           <div class="form-group">
             <label for="email">Email</label>
             <input type="text" name="email" value="<?= set_value('email')?>" class="form-control" id="email" placeholder="Email">
             <?= form_error('email', '<small class="texto-danger pl-3">', '</small>'); ?>
           </div>
           <div class="form-group">
             ...
             <?= form_error('prodi', '<small class="texto-danger pl-3">', '</small>'); ?>
           </div>
           <div class="form-group">
