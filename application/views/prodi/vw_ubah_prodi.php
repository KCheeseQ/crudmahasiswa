 ...
 <div class="card-body">
     ...
     <input type="hidden" name="id" value="<?= $prodi['id'] ?>">
          ...
          <div class="form-group">
            ...
            <input type="text" name="output_lulusan" value="<?= $prodi['output_lulusan'] ?>" class="form-control" id="output_lulusan"  placeholder="Outpu Lulusan">
            <?= form_error('output_kelulusan', '<small class="text-danger pl-3">', "</small>"); ?>
          </div>
          <div class="form-group">
            <img src="<?= base_url('assets/img/prodi/') . $prodi['gambar']; ?>" style="width: 100px" class="img-thumbnail">
            <div class="custom-file">
              <input type="file" class="custom-file-input" name="gambar" id="gambar">
              <label for="gambar" class="custome-file-label">Choose File</label>
